            ...
            if (session?.user) {
                ...
                try {
                    ...
                    if (userDoc.exists()) {
                        ...
                        // Fallback or handle missing doc
        ...
        if (step < 4) {
            ...
            if (step === 3) {
                ...
                try {
                    ...
                    // alert("Error saving data. Please try again."); // Using simplified error handling for now
                } finally {
                    setLoading(false);
                }
            }
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                        ...
                        <Input
                            ...
                            className="bg-black/20 border-white/10 text-white pl-10 h-11 appearance-none [&::-webkit-calendar-picker-indicator]:opacity-0 z-10 relative bg-transparent"
                        />
                    </div>
                </div>
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md">
                {/* Steps Indicator (Hidden on Welcome/Review for cleaner look) */}
                {step > 0 && step < 4 && (

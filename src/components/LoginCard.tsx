...
export const LoginCard = () => {
    ...
    const validateEmail = (value: string) => {
        ...
        if (value.length < 3) return "Invalid username or email";
        return "";
    };
            ...
            <div className="glass-card rounded-[22px] p-1.5 relative overflow-hidden backdrop-blur-2xl bg-black/40 border border-white/5 shadow-2xl ring-1 ring-white/5">
                <div className="bg-[#0a0a0f]/90 rounded-[18px] p-5 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3 relative z-10">
                        {/* Social Grid - Top for immediate access */}
                        ...
                        <div className="relative py-1">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                                <span className="bg-[#0a0a0f] px-2 text-muted-foreground/60">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between text-[10px] pt-0.5 opacity-80">
                            <a href="#" className="text-muted-foreground hover:text-white transition-colors">Forgot password?</a>
                            <Link to="/signup" className="text-[hsl(var(--mora-accent))] hover:text-white transition-colors font-medium">Create account</Link>
                        </div>
                    </form>
                </div>
            </div>
